...
public class RestAuthorizationException extends RuntimeException {
     ...
     *
     */
    private static final long serialVersionUID = 4987464161905973494L;
    ...
    public RestAuthorizationException(String message, Throwable cause, boolean enableSuppression,
