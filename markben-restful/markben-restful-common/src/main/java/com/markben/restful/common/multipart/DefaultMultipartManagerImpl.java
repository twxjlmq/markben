package com.markben.restful.common.multipart;
 ...
 * @since 0.0.1
 */
public class DefaultMultipartManagerImpl implements MultipartManager {

    private static final Logger logger = LoggerUtils.getLogger(DefaultMultipartManagerImpl.class);
