...
public enum ProjectEnvironmentType {
    ...
    ProjectEnvironmentType(Integer index, String value, String text) {
        this.index = index;
        this.value = value;
        this.text = text;
    }
     ...
     * @return 返回环境类型
     */
    public static ProjectEnvironmentType getObject(Integer index) {
        if(null == index) {
            return DEVELOPMENT;
        }
        ProjectEnvironmentType environmentType = DEVELOPMENT;
        for(ProjectEnvironmentType type : ProjectEnvironmentType.values()) {
     ...
     * @return 返回环境类型
     */
    public static ProjectEnvironmentType getObject(String value) {
